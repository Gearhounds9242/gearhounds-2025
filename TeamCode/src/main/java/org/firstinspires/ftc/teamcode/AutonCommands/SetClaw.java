...
public class SetClaw extends Command {
    ...
    public SetClaw(Hardware robot, ElapsedTime timer, double runTime, double servoPosition, double servoPosition1) {
        super(robot);
        this.timer = timer;
    ...
    public SetClaw(Hardware robot, ElapsedTime timer, double runTime, double servoPosition, boolean useInit, boolean useEnd) {
        super(robot);
        this.timer = timer;
        this.runTime = runTime*1000;
        this.servoPosition = servoPosition;
